...
I highly suggest reading the [giteveryday](https://git-scm.com/docs/giteveryday) for a brief introduction to many of the commands that you will see regulary when working with git.
